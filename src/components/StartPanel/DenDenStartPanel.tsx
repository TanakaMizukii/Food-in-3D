...
export default function DendenStartPanel({ onUpdate, loading }: StartPanelProps) {
    const handleClick = () => {
        onUpdate();
    };
    ...
    return(
        ...
        <MyStart>
            <div id="start-overlay" className={'startOverlay'}>
                ...
                <img src="/thumb/denden/でんでんロゴ.png" alt="メインイメージ" id="start-image" className={"startImage"} />
